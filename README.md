...
Applied these patterns to manage books, users, and notifications efficiently.
Designed the system to simulate real-world library behavior with proper architecture and clean structure.
